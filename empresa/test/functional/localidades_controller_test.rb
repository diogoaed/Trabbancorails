...
class LocalidadesControllerTest < ActionController::TestCase
  ...
  test "should create localidade" do
    assert_difference('Localidade.count') do
      post :create, :localidade => { :CEP => @localidade.CEP, :Cidade => @localidade.Cidade, :Endereco => @localidade.Endereco, :UF => @localidade.UF }
    end
  ...
  test "should update localidade" do
    put :update, :id => @localidade, :localidade => { :CEP => @localidade.CEP, :Cidade => @localidade.Cidade, :Endereco => @localidade.Endereco, :UF => @localidade.UF }
    assert_redirected_to localidade_path(assigns(:localidade))
  end
